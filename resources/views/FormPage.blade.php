...
<body>
    ...
    <div class="main-content">
        ...
        <div class="main">
        <form method="port" action=" {{ route('Product.store'}} ">
    
            <div class="help-form">
                <p class="clearfix"><input type="text" name="id" placeholder="ID San pham" value="" class="half-size"></p>
                <p><input type="text" name="name" placeholder="Ten san pham" value="" class="half-size"> </p>
                <p class="clearfix"><input type="text" name="size" placeholder="Size" class="half-size"></p>
                <p><input type="text" name="quantity" placeholder="So luong" value="" class="half-size"> </p>
                <p class="clearfix"><input type="text" name="warehouse_id" placeholder="ID kho hang" value="" class="half-size"></p>
                <p> <input type="text" name="source" placeholder="Nha san xuat" value="" class="half-size"> </p>
                 <p class="clearfix"><input type="text" name="price" placeholder="Gia ca" value="" class="half-size"> </p>
                <p class="clearfix">
